...
// __BASE_REF__, __PREVIOUS_HEAD_SHA__, __IMAGE__ at submit time. The
// double-underscore form survives prettier formatting without being
// rewritten as JSX-style braces.
//
